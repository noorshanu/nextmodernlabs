...
function StatCard({ value, suffix, label }: { value: number; suffix: string; label: string }) {
    ...
    return (
        <motion.div ref={ref} variants={staggerItem} className="relative group">
            ...
            <div className="relative bg-slate-900/70 border border-slate-800 rounded-2xl p-6 text-center hover:border-orange-500/40 transition-all duration-300">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        <div className="text-center lg:text-left">
                            ...
                            >
                                ...
                                <Link
                                    href="#services"
                                    className="inline-flex items-center gap-2 px-8 py-4 border border-slate-600 text-slate-300 font-semibold rounded-full hover:bg-slate-800/50 hover:border-orange-500/50 transition-all duration-300"
                                >
                                    See Our Services
                                </Link>
                            </motion.div>
                        ...
                        >
                            ...
                            <div className="relative w-full max-w-md">
                                ...
                                <div className="relative bg-slate-900/80 backdrop-blur-sm rounded-2xl border border-orange-700/30 p-6 shadow-2xl">
                                    {/* Header */}
                                ...
                                <motion.div
                                    ...
                                    className="absolute -bottom-4 -left-4 px-4 py-2 bg-slate-800 border border-orange-500/30 rounded-full text-orange-400 text-sm font-semibold shadow-lg"
                                >
                                    🎯 Data-Driven
                                </motion.div>
                            </div>
                ...
                <div className="relative overflow-hidden">
                    ...
                    <div className="flex animate-marquee-dm">
                        {[...techStack, ...techStack, ...techStack].map((tech, i) => (
                            <div
                                key={`${tech.name}-${i}`}
                                className="flex items-center gap-3 px-8 py-4 mx-2 bg-slate-900/50 border border-slate-800/50 rounded-xl hover:border-orange-500/30 transition-colors flex-shrink-0"
                            >
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            >
                                <button
                                    onClick={() => setShowPopup(true)}
                                    className="group inline-flex items-center gap-2 px-8 py-4 bg-white text-orange-700 font-bold rounded-full hover:shadow-2xl hover:shadow-white/20 hover:-translate-y-0.5 transition-all duration-300"
                                >
                                    Get Free Marketing Audit
                                    <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
